...
#ifndef BREEZE_DEPLOY_MODELS_CLASSIFICATION_ARCFACE_ARC_FACE_H_
#define BREEZE_DEPLOY_MODELS_CLASSIFICATION_ARCFACE_ARC_FACE_H_

#include <string>
#include "breeze_deploy/models/classification/classification_model.h"
namespace breeze_deploy {
namespace models {
class ArcFace : public ClassificationModel {
 public:
...
#endif //BREEZE_DEPLOY_MODELS_CLASSIFICATION_ARCFACE_ARC_FACE_H_
